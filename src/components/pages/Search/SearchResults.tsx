...
export default function SearchResults() {
    ...
    }), [author, selectedCategories, searchTerm, minPrice, maxPrice, pageNumber, pageSize]);
    ...
    return (
        <div className="container py-8 mx-auto px-4">
            <h2 className="text-2xl font-bold mb-6">
                Kết quả tìm kiếm: {searchTerm || 'Không có từ khóa'}
            </h2>
                    ...
                    <Card className="shadow-sm">
                        ...
                        <CardContent className="pt-6">
                            <form id="filterForm" onSubmit={handleSubmit} className="space-y-4">
                                <input type="hidden" id="title" name="title" value={searchTerm} />
