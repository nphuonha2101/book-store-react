...
export const LeftUserSideBar = ({ isProfileChanged }: { isProfileChanged?: boolean }) => {
    ...
    const SidebarContent = () => (
        <>
            <div className="flex flex-col items-center space-y-2 sm:space-y-3 mb-4 sm:mb-8 pt-2 sm:pt-4">
